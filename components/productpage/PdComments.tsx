...
const PdComments: React.FC<Props> = ({ allComents }) => {
  ...
  //   }
  // ];
  const COMENTS = allComents;

  const displayDescription: reviews[] = showAll ? COMENTS : COMENTS.slice(0, 4)
          ...
          <div className='flex justify-end items-center'>
            <Stack spacing={1}>
              <div className='md:hidden'>
                <Rating name="half-rating-read" defaultValue={item.score} precision={1} readOnly size="small"/>
              </div>
              <div className='hidden md:block'>
                <Rating name="half-rating-read" defaultValue={item.score} precision={1} readOnly />
              </div>
