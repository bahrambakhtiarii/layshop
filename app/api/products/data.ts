...
export const PRODUCTS_DATA: Product[] = [
  // محصول ۱: هدفون بلوتوثی بیتس مدل Solo 4
  {
    ...
    importantFeatures: [
      ...
      { id: 4, title: 'عمر باتری', description: 'تا 6 ساعت پخش موسیقی' },
      { id: 5, title: 'عمر باتری', description: 'تا 6 ساعت پخش موسیقی' },
      { id: 6, title: 'عمر باتری', description: 'تا 6 ساعت پخش موسیقی' },
      { id: 7, title: 'عمر باتری', description: 'تا 6 ساعت پخش موسیقی' },
      { id: 8, title: 'عمر باتری', description: 'تا 6 ساعت پخش موسیقی' },
    ],
    pdColors: [
    ...
    cartOptions: { discount: 0, warranty: 'گارانتی 18 ماهه تجارت لی شاپ' },
    reviews: [
      ...
      { id: 2, author: 'علی بهروزی', date: 'تاریخ: 1404/05/22', score: 3, comment: 'این محصول را خریداری کردم و از لحاظ کیفیت ساخت به نظرم می‌توانست بهتر باشد.' },
  ...
  // محصول ۲: ایرپاد پرو ۲ اپل
  {
    ...
    cartOptions: { discount: 0, warranty: 'گارانتی اصالت کالا' },
    reviews: [
  ...
  // محصول ۳: گلکسی بادز ۲ پرو سامسونگ
  {
    ...
    cartOptions: { discount: 0, warranty: 'گارانتی ۱۸ ماهه' },
    reviews: [
  ...
  // محصول ۴: اپل واچ سری 10
  {
    ...
    cartOptions: { discount: 0, warranty: 'گارانتی ۱۸ ماهه اپل' },
  ...
  // محصول ۵: پلی استیشن ۵ سونی
  {
    ...
    productDescription: [],
    cartOptions: { discount: 0, warranty: 'گارانتی ۱۲ ماهه' },
    reviews: [
  ...
  // محصول ۶: پاور بانک انکر
  {
    ...
    productDescription: [],
    cartOptions: { discount: 0, warranty: 'گارانتی 6 ماهه' },
    reviews: [],
  },
  ...
  // محصول ۷: می بند ۸ شیائومی
  {
    ...
    productDescription: [],
    cartOptions: { discount: 0, warranty: 'گارانتی 12 ماهه' },
    reviews: [],
  },
